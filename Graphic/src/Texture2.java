...
public class Texture2 {
    ...
    public Texture2(int width, int height, ByteBuffer buffer){
        this();
        this.setTexture1(width, height, buffer);
    }

    public Texture2(String path){
        this();
        ByteBuffer image;
        try(MemoryStack stack = MemoryStack.stackPush()){
    ...
    public Texture2(BufferedImage image){
        this();
        if(image == null){
            throw new RuntimeException("BufferImage is null, cant load image!!");
        }
    ...
    public void prepareToRender() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            /* Vertex data */
            FloatBuffer vertices = stack.mallocFloat(6 * 8);
...
//            vertices.put(x1).put(y2).put(1f).put(1f).put(1f).put(0f).put(1f);
            ...
            //alpha = 1f
            vertices.put(x1).put(y1).put(1f).put(1f).put(1f).put(1f).put(0f).put(0f);
            vertices.put(x2).put(y1).put(1f).put(1f).put(1f).put(1f).put(1f).put(0f);
            vertices.put(x2).put(y2).put(1f).put(1f).put(1f).put(1f).put(1f).put(1f);

            vertices.put(x2).put(y2).put(1f).put(1f).put(1f).put(1f).put(1f).put(1f);
            vertices.put(x1).put(y2).put(1f).put(1f).put(1f).put(1f).put(0f).put(1f);
            vertices.put(x1).put(y1).put(1f).put(1f).put(1f).put(1f).put(0f).put(0f);


            //alpha = 0f
//            vertices.put(x1).put(y1).put(1f).put(1f).put(1f).put(0f).put(0f).put(0f);
//            vertices.put(x2).put(y1).put(1f).put(1f).put(1f).put(0f).put(1f).put(0f);
//            vertices.put(x2).put(y2).put(1f).put(1f).put(1f).put(0f).put(1f).put(1f);
//
//            vertices.put(x2).put(y2).put(1f).put(1f).put(1f).put(0f).put(1f).put(1f);
//            vertices.put(x1).put(y2).put(1f).put(1f).put(1f).put(0f).put(0f).put(1f);
//            vertices.put(x1).put(y1).put(1f).put(1f).put(1f).put(0f).put(0f).put(0f);
            vertices.flip();
...
//        this.specifyVertexAttributes();
    ...
    public void drawTextureRegion(float x, float y, float regX, float regY, float regWidth, float regHeight, float scale, Color c) {
        /* Vertex positions */
        float x1 = x;
        float y1 = y;
        float x2 = x + scale*regWidth;
        float y2 = y + scale*regHeight;
    ...
    public void drawTextureRegion(float x1, float y1){
        /* Get coordinates for centering the texture on screen */
        float x2 = x1 + this.getWidth();
        float y2 = y1 + this.getHeight();
    ...
    public void drawTextureRegion(float scale){
        /* Get coordinates for centering the texture on screen */
        float x1 = (this.windowWidth - scale*this.getWidth()) / 2f;
        float y1 = (this.windowHeight - scale*this.getHeight()) / 2f;
        float x2 = x1 + scale*this.getWidth();
        float y2 = y1 + scale*this.getHeight();

        this.drawTextureRegion(x1, y1, x2, y2, 0f, 0f, 1f, 1f, Color.WHITE);
    }
    public void drawTextureRegion(float x1, float y1, float scale){
//        /* Get coordinates for centering the texture on screen */
//        float x2 = x1 + scale*this.getWidth();
//        float y2 = y1 + scale*this.getHeight();
//
//        this.drawTextureRegion(x1, y1, x2, y2, 0f, 0f, 1f, 1f, Color.WHITE);
        this.drawTextureRegion(x1, y1, scale, scale);
    }
    public void drawTextureRegion(float x1, float y1, float scaleX, float scaleY){
//        /* Get coordinates for centering the texture on screen */
//        float x2 = x1 + scaleX*this.getWidth();
//        float y2 = y1 + scaleY*this.getHeight();

        this.drawTextureRegion(x1, y1, scaleX, scaleY, Color.WHITE);
    }
    public void drawTextureRegion(float x1, float y1, float scaleX, float scaleY, Color c){
        /* Get coordinates for centering the texture on screen */
        float x2 = x1 + scaleX*this.getWidth();
        float y2 = y1 + scaleY*this.getHeight();

        this.drawTextureRegion(x1, y1, x2, y2, 0f, 0f, 1f, 1f, c);
    }
...
//        System.out.println(this.nVertices);
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            /* Vertex data */
            FloatBuffer vertices = stack.mallocFloat(this.nVertices * 8);
