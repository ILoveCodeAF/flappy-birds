...
public class Font1 {
     ...
     */
    private final Texture1 texture;

    /**
     * Contains the font texture characters.
     */
    private final Map<Character, Texture2> textureCharacters;
     ...
     */
    public Font1() {
        this(new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.PLAIN, 16), true);
    }
     ...
     */
    public Font1(boolean antiAlias) {
        this(new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.PLAIN, 16), antiAlias);
    }
     ...
     */
    public Font1(int size) {
        this(new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.PLAIN, size), true);
    }
     ...
     * @param antiAlias Wheter the font should be antialiased or not
     */
    public Font1(int size, boolean antiAlias) {
        this(new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.PLAIN, size), antiAlias);
    }
     ...
     */
    public Font1(InputStream in, int size) throws FontFormatException, IOException {
        this(in, size, true);
    }
     ...
     * @throws IOException         If font can't be read
     */
    public Font1(InputStream in, int size, boolean antiAlias) throws FontFormatException, IOException {
     ...
     */
    public Font1(java.awt.Font font) {
        this(font, true);
    }
     ...
     * @param antiAlias Wheter the font should be antialiased or not
     */
    public Font1(java.awt.Font font, boolean antiAlias) {
        this.glyphs = new HashMap<>();
        this.textureCharacters = new HashMap<>();
     ...
     * @return Font texture
     */
    private Texture1 createFontTexture(java.awt.Font font, boolean antiAlias) {
        ...
        /* Create texture */
        Texture1 fontTexture = new Texture1(width, height, buffer);
        MemoryUtil.memFree(buffer);


//        Texture2 fontTexture = new Texture2(image);
//        return fontTexture;
        return fontTexture;
    }
    ...
    public void drawText(CharSequence text, float x, float y, Color c) {
        ...
        for(int i = 0; i<text.length(); ++i){
            ...
            Glyph g = this.glyphs.get(ch);
            this.texture.drawTextureRegion(drawX, drawY, g.getX(), g.getY(), g.getWidth(), g.getHeight(), c);
            drawX += g.getWidth();
        }
        this.texture.end();
        this.texture.prepareAtrib();
        this.texture.render();
    }
