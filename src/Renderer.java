...
public class Renderer {
    ...
    private void specifyVertexAttributes(){
        ...
        GL20.glVertexAttribPointer(posAttrib, 3, GL20.GL_FLOAT, false, 6*Float.BYTES, 0);

        int colAttrib = GL20.glGetAttribLocation(this.shaderProgram, "color");
        GL20.glEnableVertexAttribArray(colAttrib);
        GL20.glVertexAttribPointer(colAttrib, 3, GL20.GL_FLOAT, false, 6*Float.BYTES, 3*Float.BYTES);
    }
    public void render(){
